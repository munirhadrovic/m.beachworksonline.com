...
<html>
	<head>
		...
		<title>Located in the Marco Town Center Mall in Beautiful Marco Island, Florida | Beachworks</title>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>">
			<h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://beachworksonline.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<fieldset class="ui-grid-a" data-theme="<?php echo $theme ?>">
					...
					<div class="ui-block-a"><a class="ui-btn ui-icon-phone ui-alt-icon ui-nodisc-icon ui-btn-icon-left buttons-radius" href="tel:<?php echo $telephone ?>">Call<br>US</a></div>
				...
				<div class="ui-grid-a" data-theme="<?php echo $theme ?>">
                    <div class="ui-block-a buttons-semir "><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-clock ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Office<br>Hours</a></div>
                    <div class="ui-block-b buttons-semir "><a class="ui-btn ui-alt-icon ui-nodisc-icon ui-icon-mail ui-btn-icon-right buttons-radius" href="#contactform" data-transition="<?php echo $transitionefect ?>">Contact<br>US</a></div>
				</div>
		  </div>
		  <h2>Located in the Marco Town Center Mall in Beautiful Marco Island, Florida</h2>
            <p>Welcome to my Beachworks online store.</p>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-home">
						<ul id="menu-home">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">Office Hours</a></li>							
